...
export type NutritionLabelDraft = ApiSchemas['NutritionLabelDraftResponse'];
export type NutritionLabelCanonicalDraft = NutritionLabelDraft['nutrition'];
export type NutritionLabelConfirmRequest = ApiSchemas['NutritionLabelConfirmRequest'];
export type NutritionLabelConfirmResponse = ApiSchemas['NutritionLabelConfirmResponse'];
export type NutritionLabelFactsEdit = ApiSchemas['NutritionLabelFactsEdit'];

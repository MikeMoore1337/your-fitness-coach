...
export type CoachAgenda = ApiSchemas['CoachAgendaResponse'];
export type CoachOperationsToday = ApiSchemas['CoachOperationsTodayResponse'];
export type CoachClientOperations = ApiSchemas['CoachClientOperationsResponse'];
export type CoachSession = ApiSchemas['CoachSessionResponse'];
export type CoachSessionCreate = ApiSchemas['CoachSessionCreate'];
export type CoachSessionUpdate = ApiSchemas['CoachSessionUpdate'];
export type CoachPackage = ApiSchemas['CoachPackageResponse'];
export type CoachPackageCreate = ApiSchemas['CoachPackageCreate'];
export type CoachPayment = ApiSchemas['CoachPaymentResponse'];
export type CoachPaymentCreate = ApiSchemas['CoachPaymentCreate'];
export type CoachPaymentUpdate = ApiSchemas['CoachPaymentUpdate'];
export type CoachTask = ApiSchemas['CoachTaskResponse'];
export type CoachTaskCreate = ApiSchemas['CoachTaskCreate'];
...
export type BodyMeasurementCustomValue = ApiSchemas['BodyMeasurementCustomValueResponse'];
export type BodyMeasurementCustomValueSave = ApiSchemas['BodyMeasurementCustomValueSave'];
export type BodyMeasurementDefinition = ApiSchemas['BodyMeasurementDefinitionResponse'];
export type BodyMeasurementDefinitionCreate = ApiSchemas['BodyMeasurementDefinitionCreate'];
export type BodyMeasurementDefinitionUpdate = ApiSchemas['BodyMeasurementDefinitionUpdate'];
...
export type FoodDiaryBatchResponse = ApiSchemas['FoodDiaryBatchResponse'];
export type NutritionMealTemplate = ApiSchemas['NutritionMealTemplateResponse'];
export type NutritionMealTemplateList = ApiSchemas['NutritionMealTemplateListResponse'];
export type NutritionMealTemplateCreate = ApiSchemas['NutritionMealTemplateCreate'];
export type NutritionMealTemplateUpdate = ApiSchemas['NutritionMealTemplateUpdate'];
export type NutritionMealTemplateItem = ApiSchemas['NutritionMealTemplateItemResponse'];
export type NaturalInputPreview = ApiSchemas['NaturalInputPreviewResponse'];
export type NaturalInputPreviewRequest = ApiSchemas['NaturalInputPreviewRequest'];
export type NaturalInputCommitRequest = ApiSchemas['NaturalInputCommitRequest'];
export type FoodSearchAlias = ApiSchemas['FoodSearchAliasResponse'];
export type FoodSearchAliasList = ApiSchemas['FoodSearchAliasListResponse'];

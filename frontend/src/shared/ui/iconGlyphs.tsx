 ...
 * Статические JSX-элементы; лицензия: public/licenses/lucide-LICENSE.txt.
...
const glyphs = {
  ...
  // Lucide: dumbbell. Горизонтальная ось; итоговый stroke 2.5 × 0.72 = 1.8.
  exercise: (
    <g transform="translate(12 12) rotate(45) scale(0.72) translate(-12 -12)" strokeWidth="2.5">

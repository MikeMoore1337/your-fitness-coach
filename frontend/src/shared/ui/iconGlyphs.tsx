...
/** Lucide: a79b2d131dab2bf20cb224bd0937b439a9c4fa99.
 * Статические JSX-элементы; лицензии: public/licenses/{lucide,phosphor}-LICENSE.txt.
 * Общие размер, цвет и stroke задаёт Icon.
 */
const glyphs = {
  // Lucide: arrow-left.
  'arrow-left': (
  ...
  settings: (
    <>
      <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 1 0-2 3.46l.15.08a2 2 0 0 1 1 1.73v.5a2 2 0 0 1-1 1.73l-.15.08a2 2 0 1 0 2 3.46l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 1 0 2-3.46l-.15-.08a2 2 0 0 1-1-1.73v-.5a2 2 0 0 1 1-1.73l.15-.08a2 2 0 1 0-2-3.46l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" />
      <circle cx="12" cy="12" r="3" />
    </>
  ),
  // Lucide: sparkles. Две искры; нижний круг исключён по образу ДО.
  'ai-coach': (
    <>
  ...
  // Phosphor: barbell (Regular). Исходная сетка 256×256 приведена к общей 24×24.
  exercise: (

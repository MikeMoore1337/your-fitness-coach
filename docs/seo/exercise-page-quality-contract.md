...
Текущий публичный allowlist намеренно мал: `bench-press`, `lat-pulldown`, `squat`. Добавление
упражнения в базу или наличие guide-профиля само по себе не включает его в public API, маршрут,
sitemap или индексацию.
